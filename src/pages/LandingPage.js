  ...
  return (
    <div className="landing-page">
      <section id="section1" className="section">
        <p data-aos="zoom-in">ExhibitEase Art Gallery</p>
        ...
        <Row className='pic mx-4 px-5 pb-5 pt-4 align-items-center'>
          <Col md={6} className= 'pt-4'>
            <div className='d-flex justify-content-between'>
              <img data-aos="fade-up" src="./image10.png" alt="..." width='48%' height='200px' />
              <img data-aos="fade-up" src="./image11.png" alt="..." width='48%' height='200px' style={{brightness:'0.1'}}/>
            </div>
            <img data-aos="fade-up" src="./i1.png" alt="..." width='100%' height='270px' style={{paddingTop:'20px'}}/>
          </Col>
          <Col className='ps-3 pt-4' data-aos="fade-left">
            <p className='picCol text-center'>ExhibitEase Art Gallery</p>
            <p className='picp text-center'>Welcome to ExhibitEase Art Gallery, an esteemed cultural institution nestled in the heart of the city. Our gallery is renowned for its exquisite collection of diverse art forms, making it a premier destination for art enthusiasts and tourists alike. With a rich history and a vibrant present, ExhibitEase is dedicated to celebrating the beauty and power of visual art.</p>
            <p className='picp text-center'>Founded in 1985, ExhibitEase Art Gallery has grown to become one of the leading art galleries in the region. Housed in a beautifully restored historical building, the gallery offers an enchanting blend of classical and contemporary architecture, providing a perfect backdrop for the artworks on display.</p>
          </Col>
        </Row>
      </section>
      <section id="section2" className="section py-4">
      <Row className='pic mx-5 p-5 align-items-center'>
          <Col className='pe-3 pt-3' data-aos="fade-right">
            <p className='head text-center'>The Collection</p>
            <p className='pipp text-center'>“IT IS PROBABLY NOT ONLY WHAT YOU SEE BUT MORE WHAT YOU FEEL."  Inviting you to experience the <b>ExhibitEase </b>Collection featuring artwork that captures the beauty and complexity of the world around us. The selection offers emotional journeys that are full of aesthetic beauty, nostalgia, and awe. Each image tells a meaningful story that connects us to the subjects. From abstract prints to landscapes, the <b>ExhibitEase</b> Collection offers a diverse range of artwork to suit any taste or style.</p>
          ...
          <Col md={6} className='text-center pt-4'>
            <img data-aos="fade-left" src="./image9.png" alt="..." width='90%' height='350px' />
          </Col>
        </Row>
      </section>
      <section id="section4" className="section py-5">
        ...
        <Row className='d-flex image mb-5' style={{width:'100%'}}>
          <Col className="image-grid pt-3" data-aos="zoom-in">
          ...
          <Col class="container collage1" data-aos="zoom-in">
